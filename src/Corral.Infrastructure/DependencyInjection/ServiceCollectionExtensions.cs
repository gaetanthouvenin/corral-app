...
/// <summary>
///   Extension methods for registering Infrastructure layer services in the dependency injection
///   container.
/// </summary>
public static class ServiceCollectionExtensions
{
  ...
  /// <summary>
  ///   Registers all Infrastructure layer services including database context, mappers, and unit of
  ///   work.
  /// </summary>
    ...
    string connectionString)
  {
    ...
    services.AddDbContext<CorralDbContext>(options => options.UseSqlite(connectionString));
